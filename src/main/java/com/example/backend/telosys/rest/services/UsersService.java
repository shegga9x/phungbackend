...
public class UsersService extends GenericService<Users, UsersDTO> {
	...
	private final UsersRepository repository; // injected by constructor
	 ...
	 * @param dto 
	 */
	public void save(int id, UsersDTO dto) {
		Integer entityId = id;
	 ...
	 * @return true if updated, false if not found
	 */
	public boolean partialUpdate(int id, UsersDTO dto) {
		Integer entityId = id;
	...
	// -----------------------------------------------------------------------------------------
/***
	public List<UsersDTO> findByTitle(String title) {
		logger.debug("findByTitle({})", title);
		// List<Users> list = repository.findByTitle(title);
		List<Users> list = repository.findByTitleContaining(title);
		return entityListToDtoList(list);
	}

	public List<UsersDTO> findByPrice(BigDecimal price) {
		logger.debug("findByPrice({})", price);
		// List<Users> list = repository.findByTitle(title);
		List<Users> list = repository.findByPrice(price);
		return entityListToDtoList(list);
	}

	public List<UsersDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Users> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}
