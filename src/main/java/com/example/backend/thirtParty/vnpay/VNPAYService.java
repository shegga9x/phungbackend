...
public class VNPAYService {
    ...
    public VNPAYService(UserService userService, ApplicationProperties applicationProperties) {
        super();
    ...
    public String createOrder(HttpServletRequest request, BigDecimal amount, Long userId, String urlReturn)
        ...
        vnp_Params.put("vnp_ReturnUrl", applicationProperties.getBaseUrl() + VNPAYConfig.vnp_Returnurl);
